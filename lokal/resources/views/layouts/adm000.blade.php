...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="{{ url('/hometown')}}" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>A</b>oL</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">Agend<b>OL</b></span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <ul class="dropdown-menu">
            <li> <a href="#"><i class="fa fa-user-secret" aria-hidden="true"></i> Profil</a></li>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ url('/skeluar') }}"><i class="fa fa-share" aria-hidden="true"></i> Surat keluar</a></li>
