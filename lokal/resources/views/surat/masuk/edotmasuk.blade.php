        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="panel panel-primary">
              ...
              <form action="{{route('cin.update', $smasuk->id)}}" method="post" accept-charset="utf-8" enctype="multipart/form-data" >
                    ...
                    <div class="col-lg-8" style="margin-top: 19px; border: 1px">
                      ...
                      <div class="form-group" {{ ($errors->has('no_agenda')) ? $errors->first('title'): '' }}>
                        ...
                        <div class="col-sm-10">
                          <input type="text" style="margin-top: 10px; width: 500px" class="form-control" id="no_agenda" name="no_agenda" value="{{ $smasuk->no_agenda }}">
                      ...
                      <div class="form-group"  {{ ($errors->has('tgl_masuk')) ? $errors->first('title'): '' }}>
                        ...
                        <div class="col-sm-10">
                          <input type="text" style="margin-top: 10px; width: 500px" class="form-control" name="tgl_masuk" id="tgl_masuk" value="{{ $smasuk->tgl_masuk }}">
                      ...
                      <div class="form-group" {{ ($errors->has('asal_surat')) ? $errors->first('title'): '' }}>
                        ...
                        <div class="col-sm-10">
                          <input type="text" style="margin-top: 10px; width: 500px" class="form-control" name = "asal_surat" id="asal_surat" value="{{ $smasuk->asal_surat }}">
                      ...
                      <div class="form-group" {{ ($errors->has('no_surat')) ? $errors->first('title'): '' }}>
                        ...
                        <div class="col-sm-10">
                          <input type="text" style="margin-top: 10px; width: 500px" class="form-control" name="no_surat" id="no_surat" value="{{ $smasuk->no_surat }}">
                      ...
                      <div class="form-group"  {{ ($errors->has('tgl_surat')) ? $errors->first('title'): '' }}>
                        ...
                        <div class="col-sm-10">
                          <input type="text" style="margin-top: 10px; width: 500px" class="form-control" name="tgl_surat" id="tgl_surat" value="{{ $smasuk->tgl_surat }}">
                      ...
                      <div class="form-group" {{ ($errors->has('perihal')) ? $errors->first('title'): '' }}>
                        ...
                        <div class="col-sm-10">
                          <textarea type="text" style="margin-top: 10px; width: 500px; height: 120px" class="form-control" name="perihal" id="perihal" placeholder="Inputkan Perihal" value="{{ $smasuk->no_agenda }}" > {{ $smasuk->perihal }}</textarea>
                      ...
                      <div class="form-group" {{ ($errors->has('penerima')) ? $errors->first('title'): '' }}>
                        ...
                        <div class="col-sm-10">
                          <input type="text" style="margin-top: 10px; width: 500px" class="form-control" name="penerima" id="penerima" value="{{Auth::user()->name}}">
                      ...
                      <div class="form-group"  {{ ($errors->has('posisi')) ? $errors->first('title'): '' }}>
                        ...
                        <div class="col-sm-10">
                          <input type="text" style="margin-top: 10px; width: 500px" class="form-control" name="posisi" id="posisi" value="{{ $smasuk->posisi }}">
                      ...
                      <div class="form-group"  {{ ($errors->has('berkas')) ? $errors->first('title'): '' }}>
                        ...
                        <div class="col-sm-10">
                          <input type="file" style="margin-top: 10px; width: 500px" class="form-control" name="berkas" id="berkas" value="{{ $smasuk->berkas }}">
