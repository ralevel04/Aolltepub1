        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="panel panel-primary">
              ...
              <form action="{{route('cout.store')}}" method="post" accept-charset="utf-8" enctype="multipart/form-data" >
                            {{csrf_field()}}
                    ...
                    <div class="col-lg-8" style="margin-top: 19px; border: 1px">
                      ...
                      <div class="form-group"  {{ ($errors->has('tgl_keluar')) ? $errors->first('title'): '' }}>
                        ...
                        <div class="col-sm-10">
                          <input type="text" style="margin-top: 10px; width: 500px" class="form-control" name="tgl_keluar" id="tgl_keluar" placeholder="Inputkan Tgl Terima">
                                {!! $errors->first('tgl_keluar', '<p class="help-block">:message</p>') !!}
                        </div>
                      </div>

                      <div class="form-group" {{ ($errors->has('tujuan_surat')) ? $errors->first('title'): '' }}>
                        <label for="tujuan_surat" style="margin-top: 10px" class="col-sm-2 control-label">Tujuan Surat</label>
                        <div class="col-sm-10">
                          <input type="text" style="margin-top: 10px; width: 500px" class="form-control" name = "tujuan_surat" id="tujuan_surat" placeholder="Inputkan Tujuan Surat">
                      ...
                      <div class="form-group" {{ ($errors->has('pembuat')) ? $errors->first('title'): '' }}>
                        ...
                        <div class="col-sm-10">
                          <input type="text" style="margin-top: 10px; width: 500px" class="form-control" name="pembuat" id="pembuat" placeholder="Inputkan Pembuat" value="{{Auth::user()->name}}">
